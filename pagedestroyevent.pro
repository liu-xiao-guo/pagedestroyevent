...
UBUNTU_TRANSLATION_DOMAIN="pagedestroyevent.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pagedestroyevent/tests/autopilot/run
aptest.depends  = sub-pagedestroyevent

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pagedestroyevent/tests/unit
unittest.depends  = sub-pagedestroyevent
